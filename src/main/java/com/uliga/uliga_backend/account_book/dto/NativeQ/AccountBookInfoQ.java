...
public class AccountBookInfoQ {
  ...
  public AccountBookInfoQ(Long accountBookId, Boolean isPrivate, String accountBookName,
      AccountBookAuthority accountBookAuthority, Boolean getNotification, String relationShip, String avatarUrl) {
