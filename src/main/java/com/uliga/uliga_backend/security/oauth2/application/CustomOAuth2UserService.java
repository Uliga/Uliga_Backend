...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
  ...
  public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
    ...
    // memberRepository.findByEmailAndDeleted(userInfo.getEmail(), false);
    // Member member = byEmailAndDeleted.orElseGet(() -> createUser(userInfo,
    // loginType));
    Member member = memberRepository.findByEmailAndDeleted(userInfo.getEmail(), false)
