...
public interface IncomeRepository {
  ...
  // @Query("select new
  // com.uliga.uliga_backend.domain.Income.dto.NativeQ.IncomeInfoQ(" +
  // "i.id," +
  // "i.value," +
  // "i.payment," +
  // "i.account," +
  ...
  // "JOIN Category c on c.id = i.category.id JOIN AccountBookMember abm ON
  // abm.accountBook.id = i.accountBook.id AND abm.member.id = i.creator.id "
  // +
  ...
  // @Modifying
  // @Query(nativeQuery = true, value = "INSERT INTO income (account_book_data_id)
  // value (:id)")
