package com.uliga.uliga_backend.income.model;
...
public class Income {
  ...
  // @Builder
  // public Income(Long id, Long value, String payment, String account, String
  // memo, Date date, Member creator,
  // AccountBook accountBook, Category category) {
  // super(id, value, payment, account, memo, date, AccountBookDataType.INCOME,
  // creator, category, accountBook);
  // }
