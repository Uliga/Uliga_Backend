package com.uliga.uliga_backend.schedule.service;
...
public class ScheduleService {
  ...
  // .schedules(scheduleRepository.findByMemberId(id,
  // now.getDayOfMonth())).build();
  // }
  ...
  // */
  // @Transactional
  // public AddScheduleResult addSchedule(Long currentMemberId, AddSchedules
  // addSchedules)
  ...
  // accountBookRepository.findById(addSchedules.getId())
  // .orElseThrow(() -> new NotFoundByIdException("해당 아이디로 존재하는 가계부가 없습니다"));

  // SetOperations<String, String> setOperations = redisTemplate.opsForSet();
  // List<CreateScheduleRequest> result = new ArrayList<>();
  // List<Member> memberByAccountBookId =
  // memberRepository.findMemberByAccountBookId(accountBook.getId());
  ...
  // redisTemplate.expire(memberMap.get(assignment.getId()).getNickName(),
  ...
  // UpdateScheduleRequest scheduleRequest = mapper.convertValue(updates,
  ...
  // List<ScheduleMember> byScheduleId =
  // scheduleMemberRepository.findByScheduleId(schedule.getId());
  ...
  // */
  // @Transactional(readOnly = true)
  // public GetAccountBookSchedules getAccountBookSchedules(Long memberId, Long
  // accountBookId) {
  // if
  ...
  // List<ScheduleInfoQ> byAccountBookId =
  // scheduleRepository.findScheduleInfoByAccountBookId(accountBookId,
  // date.getDayOfMonth());
  ...
  // GetAccountBookSchedules accountBookSchedules =
  // GetAccountBookSchedules.builder().build();
  // accountBookSchedules.setSchedules(result);
  // List<ScheduleMonthSum> scheduleMonthSum =
  // scheduleMapper.getScheduleMonthSum(map);
  ...
  // */
  // @Transactional(readOnly = true)
  // public AccountBookScheduleAnalyze getScheduleAnalyze(Long accountBookId, Long
  // currentMemberId) {

  // return ScheduleDTO.AccountBookScheduleAnalyze.builder()
  // .schedules(scheduleRepository.findScheduleAnalyzeByAccountBookId(accountBookId,
  // currentMemberId))
  // .sum(scheduleRepository.getMonthlyScheduleValue(accountBookId,
  // currentMemberId).getValue()).build();
  // }
