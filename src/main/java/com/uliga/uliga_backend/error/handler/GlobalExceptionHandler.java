package com.uliga.uliga_backend.error.handler;
...
import com.uliga.uliga_backend.error.exception.IdNotFoundException;
import com.uliga.uliga_backend.error.exception.InvalidDataValueException;
...
public class GlobalExceptionHandler {
  ...
  protected final ResponseEntity<ErrorResponse> handleIdNotFoundException(
    ...
    return new ResponseEntity<>(ErrorResponse.builder()
        .errorCode(404L)
        .message(ex.getMessage()).build(), NOT_FOUND);
  }
  ...
  protected final ResponseEntity<ErrorResponse> handleInvalidDataValue(
    ...
    return new ResponseEntity<>(ErrorResponse.builder()
        .errorCode(409L)
        .message(ex.getMessage()).build(), CONFLICT);
  }
