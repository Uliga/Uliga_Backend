package com.uliga.uliga_backend.record.service;
...
public class RecordService {
  ...
  // public MonthlySumQ getMonthlyRecordSum(Long accountBookId, Long year, Long
  // month) {
  // return recordRepository.getMonthlySumByAccountBookId(accountBookId, year,
  // month).orElse(new MonthlySumQ(0L));
  // }
  ...
  // */
  // @Transactional
  // public AddRecordResult addRecord(Long currentMemberId, AddRecordRequest
  // addRecordRequest) {
  // AccountBook accountBook =
  // accountBookRepository.findById(addRecordRequest.getId())
  // .orElseThrow(() -> new NotFoundByIdException("해당 아이디로 존재하는 가계부가 없습니다"));
  // Category category = categoryRepository.findByAccountBookAndName(accountBook,
  // addRecordRequest.getCategory())
  ...
  // categoryRepository.findCategoriesByAccountBookIds(sharedAccountBookIds);
  ...
  // RecordUpdateRequest patchRecord = objectMapper.convertValue(updates,
  // RecordUpdateRequest.class);
  ...
  // }
  // if (patchRecord.getType() != null &&
  // patchRecord.getType().equals(AccountBookDataType.INCOME.toString())) {
  // record.updateType();
  ...
  // */
  // @Transactional(readOnly = true)
  // public Page<RecordInfoQ> getMemberRecordsByAccountBook(Long accountBookId,
  // Long categoryId, Long year, Long month,
  // Pageable pageable) {
  ...
  // ;
  // List<RecordInfoQ> accountBookMemberRecords =
  // mapper.findAccountBookMemberRecords(map);
  ...
  // */
  // @Transactional(readOnly = true)
  // public AccountBookDataDTO.AccountBookDailyRecordSumAndMonthlySum
  // getDailyRecordSumAndMonthlySum(Long accountBookId,
  // Long year, Long month) {
  // List<DailyValueQ> monthlyRecord =
  // recordRepository.getDailyRecordSumOfMonth(accountBookId, year, month);
  ...
  // Long diff = monthlyCompareInDailyAnalyze.get(0).getValue() -
  // monthlyCompareInDailyAnalyze.get(1).getValue();
  ...
  // */
  // @Transactional(readOnly = true)
  // public MonthlyRecordSumPerCategories getMonthlyRecordSumPerCategories(Long
  // accountBookId, Long year, Long month) {
  ...
  // Optional<MonthlySumQ> monthlySum =
  // recordRepository.getMonthlySumByAccountBookId(accountBookId, year, month);
  ...
  // return new CategoryDTO.MonthlyRecordSumPerCategories(categoryAnalyze,
  // monthlySumQ.getValue());
  // } else {
  // AccountBookCategoryAnalyzeQ built = new AccountBookCategoryAnalyzeQ(null, "그
  // 외",
  ...
  // }
  // } else {
  // List<AccountBookCategoryInfoQ> accountBookCategoryInfoById =
  // categoryRepository
  // .findAccountBookCategoryAnalyze(accountBookId);
  // List<AccountBookCategoryAnalyzeQ> result = new ArrayList<>();
  // for (AccountBookCategoryInfoQ accountBookCategoryInfoQ :
  // accountBookCategoryInfoById) {
  // AccountBookCategoryAnalyzeQ built = new
  // AccountBookCategoryAnalyzeQ(accountBookCategoryInfoQ.getId(),
  ...
  // */
  // @Transactional(readOnly = true)
  // public AccountBookWeeklyRecord getWeeklyRecordSum(Long accountBookId, Long
  // year, Long month, Long startDay) {
  // Long totalSum = 0L;
  ...
  // Optional<WeeklySumQ> weeklyRecordSum =
  // recordRepository.getWeeklyRecordSum(accountBookId, year, month,
  // startDay, startDay + 7);
  // long endDay;
  ...
  // AccountBookDataDTO.WeeklySum weeklySum =
  // AccountBookDataDTO.WeeklySum.builder().startDay(startDay)
  ...
  // */
  // @Transactional
  // public RecordCommentInfoQ addCommentToRecord(Long id, RecordCommentCreateDto
  // createDto) {
  // return null;
  // }
