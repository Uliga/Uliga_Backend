...
public class AuthService {
    ...
    public Member signUp(SignUpRequest signUpRequest) {
        ...
        CreateRequestPrivate requestPrivate = CreateRequestPrivate.builder().name(member.getUserName() + " 님의 가계부")
    ...
    public LoginResult socialLogin(SocialLoginRequest socialLoginRequest) {
        ...
        CreateRequestPrivate requestPrivate = CreateRequestPrivate.builder().name(entity.getUserName() + " 님의 가계부")
                .relationship("개인").isPrivate(true).build();
        AccountBook accountBookPrivateSocialLogin = accountBookService
