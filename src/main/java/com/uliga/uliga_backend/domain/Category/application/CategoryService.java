...
public class CategoryService {
  ...
  // private final List<St Arrays.asList("\uD83C\uDF7D️ 식비","☕ 카페 ·
  // 간식","\uD83C\uDFE0 생활","\uD83C\uDF59 편의점,마트,잡화","\uD83D\uDC55 쇼핑","기타"));
  ...
  // */
  // @Transactional
  // public String createCategoriesForNewAccountBook(AccountBook accountBook,
  ...
  // */
  // @Transactional
  // public CategoryCreateResult createCategories(Long currentMemberId,
  ...
  // if
  // (!accountBookMemberRepository.existsAccountBookMemberByMemberIdAndAccountBookId(currentMemberId,
  // accountBookId)) {
  ...
  // return
  // CategoryCreateResult.builder().id(accountBook.getId()).created(result).build();
  // }
  ...
  // public CategoryDTO.AccountBookCategories getAccountBookCategories(Long
  // accountBookId) {
  // return new
  // CategoryDTO.AccountBookCategories(categoryRepository.findAccountBookCategoryInfoById(accountBookId));
  // }
  ...
  // */
  // @Transactional
  // public String updateAccountBookCategory(Long accountBookId, List<String>
  // categories) {
  // HashSet<String> categoryNamesByAccountBookId = categoryRepository
  // .findCategoryNamesByAccountBookId(accountBookId);
  // AccountBook accountBook =
  // accountBookRepository.findById(accountBookId).orElseThrow(NotFoundByIdException::new);
  ...
  // */
  // @Transactional
  // public CategoryUpdateRequest updateCategory(Long categoryId, Map<String,
  // Object> map) {
  // Category category = categoryRepository.findById(categoryId)
  // .orElseThrow(() -> new NotFoundByIdException("해당 아이디로 존재하는 카테고리가 없습니다"));
  // AccountBook accountBook = category.getAccountBook();
  // CategoryUpdateRequest categoryUpdateRequest = mapper.convertValue(map,
  // CategoryUpdateRequest.class);
  // if (categoryUpdateRequest.getName() != null) {
  // if (categoryRepository.existsByAccountBookIdAndName(accountBook.getId(),
