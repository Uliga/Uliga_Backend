...
public interface CategoryRepository extends JpaRepository<Category, Long> {
        ...
        List<AccountBookCategoryAnalyzeQ> findAccountBookCategoryAnalyze(@Param("id") Long id, @Param("year") Long year,
        ...
        List<String> findExtraAccountBookCategory(@Param("id") Long id, @Param("year") Long year,
                        @Param("month") Long month);
