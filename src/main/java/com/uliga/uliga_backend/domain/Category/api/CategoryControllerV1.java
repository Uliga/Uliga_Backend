...
public class CategoryControllerV1 {
  ...
  public ResponseEntity<String> deleteCategory(
      @Parameter(name = "id", description = "카테고리 아이디", in = ParameterIn.PATH) @PathVariable("id") Long id) {
  ...
  public ResponseEntity<CategoryUpdateRequest> updateCategory(@PathVariable("id") Long id,
