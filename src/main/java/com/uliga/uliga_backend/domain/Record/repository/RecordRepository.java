...
public interface RecordRepository extends JpaRepository<Record, Long> {
        ...
        @Query("SELECT NEW com.uliga.uliga_backend.domain.Record.dto.NativeQ.RecordInfoQ(" +
                        "r.id," +
                        "r.value," +
                        "r.payment," +
                        "r.account," +
        ...
        Optional<MonthlySumQ> getMonthlySumByAccountBookId(@Param("id") Long id, @Param("year") Long year,
                        @Param("month") Long month);
        ...
        Optional<MonthlyCompareQ> getMonthlyCompare(@Param("accountBookId") Long accountBookId,
                        @Param("year") Long year,
                        @Param("month") Long month);
        ...
        List<MonthlyCompareQ> getMonthlyCompareInDailyAnalyze(@Param("accountBookId") Long accountBookId,
        ...
        @Query("SELECT NEW com.uliga.uliga_backend.domain.Record.dto.NativeQ.WeeklySumQ(SUM(r.value)) " +
                        ...
                        "GROUP BY r.date.year, r.date.month")
        Optional<WeeklySumQ> getWeeklyRecordSum(@Param("accountBookId") Long accountBookId, @Param("year") Long year,
                        @Param("month") Long month, @Param("startDay") Long startDay, @Param("endDay") Long endDay);
