package com.uliga.uliga_backend.domain.expense.api;
...
import com.uliga.uliga_backend.domain.expense.application.ExpenseService;
...
import com.uliga.uliga_backend.domain.expense.dto.res.ExpenseDto;
...
public class ExpenseController {
  ...
  public ResponseEntity<Flux<Expense>> getExpenses(@ModelAttribute ExpenseQueryDto query) {
    return ResponseEntity.ok(expenseService.getExpenses(query));
  }
