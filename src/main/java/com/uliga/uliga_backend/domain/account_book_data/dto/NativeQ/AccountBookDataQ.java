...
public class AccountBookDataQ {
  ...
  @Builder
  public AccountBookDataQ(Long id, Long value, String payment, String account, String memo, Long year, Long month,
      Long day, AccountBookDataType type, String creator, String category, String avatarUrl) {
    this.id = id;
    this.value = value;
