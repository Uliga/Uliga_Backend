package com.uliga.uliga_backend.domain.account_book_data.dto;
...
public class AccountBookDataDTO {
  ...
  // public Record toRecord(AccountBook accountBook, Member member, Date date,
  // Category category) {
  ...
  // public Income toIncome(AccountBook accountBook, Member member, Date date,
  // Category category) {
