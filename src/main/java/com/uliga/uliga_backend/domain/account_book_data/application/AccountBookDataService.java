...
import com.uliga.uliga_backend.domain.account_book_data.dto.AccountBookDataDTO.CreateRecordOrIncomeDto;
...
import com.uliga.uliga_backend.domain.account_book_data.mapper.AccountBookDataMapper;
import com.uliga.uliga_backend.domain.account_book_data.repository.AccountBookDataRepository;
...
public class AccountBookDataService {
     ...
     */
    @Transactional(readOnly = true)
    public DailyAccountBookDataDetails getDailyAccountBookDataDetails(Long accountBookId, Long year, Long month,
            Long day) {
     ...
     */
    @Transactional(readOnly = true)
    public Page<AccountBookDataQ> getAccountBookHistory(Long accountBookId, Long categoryId, Long year, Long month,
            Pageable pageable) {
        HashMap<String, Object> map = new HashMap<>();
        map.put("accountBookId", accountBookId);
    ...
    public MonthlyCompare getAccountBookDataMonthlyCompare(Long accountBookId, Long year, Long month) {
        ...
        for (int i = 2; i > -1; i--) {
            ...
            if (monthly.isPresent()) {
                ...
                MonthlyCompareQ build = MonthlyCompareQ.builder().year((long) calendar.get(Calendar.YEAR))
     ...
     */
    @Transactional(readOnly = true)
    public Page<AccountBookDataQ> getMonthlyAccountBookDetail(Long accountBookId, Long year, Long month,
        ...
        if (Objects.equals(category, "그 외")) {
            List<String> extraAccountBookCategory = categoryRepository.findExtraAccountBookCategory(accountBookId, year,
                    month);
     ...
     */
    @Transactional(readOnly = true)
    public Page<AccountBookDataQ> getCustomAccountBookData(Long id, Long year, Long month, Long startDay, Long endDay,
