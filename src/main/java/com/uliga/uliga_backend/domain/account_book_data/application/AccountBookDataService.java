package com.uliga.uliga_backend.domain.account_book_data.application;
...
public class AccountBookDataService {
  ...
  // public AccountBookDataDailySum getAccountBookItems(Long accountBookId, Long
  // year, Long month) {

  // return AccountBookDataDTO.AccountBookDataDailySum.builder()
  // .incomes(incomeRepository.getDailyIncomeSumOfMonth(accountBookId, year,
  // month))
  // .records(recordRepository.getDailyRecordSumOfMonth(accountBookId, year,
  // month)).build();
  // }
  ...
  // */
  // @Transactional(readOnly = true)
  // public DailyAccountBookDataDetails getDailyAccountBookDataDetails(Long
  ...
  // map.put("month", month);
  // map.put("day", day);
  // return new AccountBookDataDTO.DailyAccountBookDataDetails(
  // accountBookDataMapper.findAccountBookDataOrderByValue(map));
  // }
  ...
  // */
  // @Transactional
  // public CreateResult createItems(Long id, AccountBookDataDTO.CreateItems
  // createItems) {
  // long r = 0L;
  // long i = 0L;
  // // 아이템 작성자
  ...
  // // 현재 작성하고 있는 가계부
  // AccountBook accountBook = accountBookRepository.findById(createItems.getId())
  ...
  // // 다른 가계부들의 기타 카테고리 객체
  // List<Category> otherAccountBookDefaultCategories =
  // categoryRepository.findCategoriesByMemberIdAndName(id, "기타");
  // // 다른 공유 가계부 객체
  // List<AccountBook> accountBooks =
  // accountBookRepository.findAccountBooksByMemberId(id);
  ...
  // */
  // @Transactional(readOnly = true)
  // public Page<AccountBookDataQ> getAccountBookHistory(Long accountBookId, Long
  // categoryId, Long year, Long month,
  // Pageable pageable) {
  // HashMap<String, Object> map = new HashMap<>();
  // map.put("accountBookId", accountBookId);
  ...
  // List<AccountBookDataQ> accountBookData =
  // accountBookDataMapper.findAccountBookData(map);
  // List<Long> counted =
  // accountBookDataMapper.countQueryForAccountBookHistory(map);
  ...
  // */
  // @Transactional(readOnly = true)
  // public MonthlyCompare getAccountBookDataMonthlyCompare(Long accountBookId,
  ...
  // Optional<MonthlyCompareQ> monthly =
  // recordRepository.getMonthlyCompare(accountBookId, year, month - i);
  // if (monthly.isPresent()) {
  // monthlyCompare.add(monthly.get());
  // } else {
  // MonthlyCompareQ build = MonthlyCompareQ.builder().year((long)
  // calendar.get(Calendar.YEAR))
  // .month((long) calendar.get(Calendar.MONTH)).value(0L).build();
  ...
  // */
  // @Transactional(readOnly = true)
  // public Page<AccountBookDataQ> getMonthlyAccountBookDetail(Long accountBookId,
  // Long year, Long month,
  ...
  // List<String> extraAccountBookCategory =
  // categoryRepository.findExtraAccountBookCategory(accountBookId, year,
  // month);
  ...
  // List<AccountBookDataQ> accountBookData =
  // accountBookDataMapper.findExtraAccountBookDataAnalyze(map);
  // List<Long> counted =
  // accountBookDataMapper.countQueryForExtraAccountBookDataAnalyze(map);
  // return new PageImpl<>(accountBookData, pageable, counted.size());
  ...
  // List<AccountBookDataQ> accountBookData =
  // accountBookDataMapper.findAccountBookDataAnalyze(map);
  // List<Long> counted =
  // accountBookDataMapper.countQueryForAccountBookDataAnalyze(map);
  // return new PageImpl<>(accountBookData, pageable, counted.size());
  // }
  // }
  ...
  // */
  // @Transactional(readOnly = true)
  // public Page<AccountBookDataQ> getCustomAccountBookData(Long id, Long year,
  // Long month, Long startDay, Long endDay,
  ...
  // List<AccountBookDataQ> accountBookData =
  // accountBookDataMapper.findCustomAccountBookData(map);
  // List<Long> counted =
  // accountBookDataMapper.countQueryForCustomAccountBookData(map);
  // return new PageImpl<>(accountBookData, pageable, counted.size());
  // }
}
