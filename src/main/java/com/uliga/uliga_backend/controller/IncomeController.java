...
import com.uliga.uliga_backend.service.IncomeService;
...
public class IncomeController {
  ...
  // @ApiResponses(value = {
  // @ApiResponse(responseCode = "200", description = "수입 업데이트시", content =
  // @Content(schema = @Schema(implementation = IncomeUpdateRequest.class))),
  ...
  // @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "수입 업데이트
  // 요청", content = @Content(schema = @Schema(implementation =
  // IncomeUpdateRequest.class))) @RequestBody Map<String, Object> updates) {
  ...
  // @Content(schema = @Schema(implementation = IncomeInfoQ.class))),
  // @ApiResponse(responseCode = "401", description = "엑세스 만료시", content =
  // @Content(schema = @Schema(implementation = ErrorResponse.class)))
  // })
  // @GetMapping("")
  ...
  // return ResponseEntity.ok(incomeService.getMemberIncomes(currentMemberId,
  // pageable));
  // }

  // @Operation(summary = "멤버 수입 가계부 별 전체/년도별/월회 조회 API", description = "멤버 수입 가계부
  // 별 전체/월별 조회 API 입니다")
  // @ApiResponses(value = {
  // @ApiResponse(responseCode = "200", description = "조회 성공시", content =
  // @Content(schema = @Schema(implementation = IncomeInfoQ.class))),
  ...
  // return ResponseEntity.ok(incomeService.getMemberIncomesByAccountBook(id,
  ...
  // @Parameter(name = "id", description = "수입 아이디", in = PATH)
  // @PathVariable("id") Long id) {
