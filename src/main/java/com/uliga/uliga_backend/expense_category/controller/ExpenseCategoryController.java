package com.uliga.uliga_backend.expense_category.controller;
...
public class ExpenseCategoryController {
  ...
  public ResponseEntity<Flux<ExpenseCategory>> getExpenseCategories(@ModelAttribute ExpenseCategoryQueryDto query) {
